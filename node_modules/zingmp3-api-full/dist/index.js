...
const VERSION = "1.6.18";// 1.5.4
const URL = "https://zingmp3.vn";
const URL_V2 = "https://ac.zingmp3.vn";
...
// vesion 2
const getCookie_v2 = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let res = yield axios.get(`${URL_v2}`);
        return res.headers["set-cookie_v2"][1];
    }
    catch (err) {
        console.error(err);
    }
...
const client_v2 = axios.create({
    baseURL: `${URL_V2}`,
});
client_v2.interceptors.response.use((res) => res.data); // setting axiosresponse data

const requestZingMp3_v2 = (path, query) => __awaiter(void 0, void 0, void 0, function* () {
    let cookie = yield getCookie_v2();
    console.log(cookie)
    try {
        let res = yield client_v2.get(path, {
            headers: {
                Cookie: `${cookie}`,
            },
            params: {query},
...
const getSectionRelate = (id) => __awaiter(void 0, void 0, void 0, function* () {
    return yield requestZingMp3("/api/v2/video/get/section-relate", {
        id,
        sig: hashParam("/api/v2/video/get/section-relate", id),
    });
});
exports.getSectionRelate = getSectionRelate;

const getHotKey = () => __awaiter(void 0, void 0, void 0, function* () {
    return yield requestZingMp3("/api/v2/app/get/hot-keyword", {
        sig: hashParam("/api/v2/app/get/hot-keyword"),
    });
});
exports.getHotKey = getHotKey;
const getHome = (page,count) => __awaiter(void 0, void 0, void 0, function* () {
...
const getBottomPlaylist = (id) => __awaiter(void 0, void 0, void 0, function* () {
    return yield requestZingMp3("/api/v2/playlist/get/section-bottom", {
        id: id,
        sig: hashParam("/api/v2/playlist/get/section-bottom", id),
    });
});
exports.getBottomPlaylist = getBottomPlaylist;

const getSongList = (idSong) => __awaiter(void 0, void 0, void 0, function* () {
    return yield requestZingMp3("/api/v2/page/get/song", {
        id: idSong,
        sig: hashParam("/api/v2/page/get/song", idSong),
    });
});
exports.getSongList = getSongList;

const hashTest = (path,num, query,language) => {
    return getHmac512(path + getHash256(`num=${num}query=${query}language=${language}ctime=${CTIME}version=${v}`), SECRET_KEY);
};
const getSuggest = (query) => __awaiter(void 0, void 0, void 0, function* () {
    return yield requestZingMp3_v2("/v1/web/suggestion-keywords",query);
});
...
exports.default = {
    ...
    getBottomPlaylist:exports.getBottomPlaylist,
    getSongList:exports.getSongList,
    getHotKey :exports.getHotKey,
    getSuggest :exports.getSuggest,
    getSectionRelate :exports.getSectionRelate,

};
//# sourceMappingURL=index.js.map
//https://zingmp3.vn/api/v2/page/get/home?page=1&count=30&segmentId=-1&ctime=1648225771&version=1.6.8&sig=37f5d27b1216d79e34d372a316681bf95b50a6bdf2bc7b2ead3ce197e7921f188a75d0e5ec57eaf50b560e382f11a5fab0854e35b6a09d242cc29f81f14f7422&apiKey=88265e23d4284f25963e6eedac8fbfa3
