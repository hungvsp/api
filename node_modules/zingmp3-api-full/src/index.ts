...
export const getBottomPlaylist = async (songId: void) => {
  return await requestZingMp3("/api/v2/playlist/get/section-bottom", {
    id: songId,
    sig: hashParam("/api/v2/playlist/get/section-bottom", songId),
  });
};
export const getSongList = async (idSong: void) => {
  return await requestZingMp3("/api/v2/page/get/song", {
    id: idSong,
    sig: hashParam("/api/v2/page/get/song", idSong),
  });
};
export const getSectionRelate = async (id: void) => {
  return await requestZingMp3("/api/v2/video/get/section-relate", {
    id,
